...
class TestMatmul(TestCase):
    ...
    def test_m0_error(self):
        self.do_matmul([0], 0, 0, [0], 0, 0, [0], 72)

    def test_m1_error(self):
        self.do_matmul([1], 1, 1, [0], 0, 0, [0], 73)

    def test_mismatch_error(self):
        self.do_matmul([1], 1, 1, [1, 2, 3, 4], 2, 2, [0], 74)
...
class TestClassify(TestCase):
    ...
    def test_incorrect_number_error(self):
        t = self.make_test()
        args = [
            "inputs/simple0/bin/m0.bin",
            "inputs/simple0/bin/m1.bin",
